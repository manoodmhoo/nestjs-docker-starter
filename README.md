...
โปรเจค NestJS พื้นฐานสำหรับการเริ่มต้นพัฒนา API ด้วย TypeScript, MySQL และ Docker

## 📋 ข้อมูลโปรเจค

โปรเจคนี้เป็น template สำหรับการพัฒนา RESTful API ด้วย NestJS ที่มีความสามารถดังต่อไปนี้:

- 🔐 ระบบการยืนยันตัวตน (Authentication) ด้วย Passport
- 🗄️ ฐานข้อมูล MySQL ด้วย TypeORM
- 🔒 เข้ารหัสรหัสผ่านด้วย Argon2
- 📝 ระบบ Logging ด้วย Winston
- 🛡️ ความปลอดภัยด้วย Helmet
...
ก่อนเริ่มใช้งานโปรเจค กรุณาติดตั้งโปรแกรมต่อไปนี้:

- [Node.js](https://nodejs.org/) (เวอร์ชัน 18 หรือสูงกว่า)
- [npm](https://www.npmjs.com/) หรือ [yarn](https://yarnpkg.com/)
- [Docker](https://www.docker.com/) และ [Docker Compose](https://docs.docker.com/compose/) (สำหรับการรันด้วย Docker)
- [MySQL](https://www.mysql.com/) (หากไม่ใช้ Docker)
...
1. เข้าไปที่ http://localhost:8080
2. Login ด้วย:
   - Server: `db`
   - Username: `root`
   - Password: `rootpassword`
